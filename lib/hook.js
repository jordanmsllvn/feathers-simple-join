...
var simpleJoin_1 = __importDefault(require("./simpleJoin"));
/**
 ...
 * @param options
 */
exports.default = (function (options) { return function (context) { return __awaiter(void 0, void 0, void 0, function () {
    var finalOptions, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (context.type !== "after") {
                    throw new Error("feathers-simple-join: The simpleJoinHook can only be used as an after hook.");
                }
                finalOptions = {
                    with: __assign(__assign({}, options.with), { service: context.app.service(options.with.service) }),
                    include: options.include,
                    exclude: options.exclude
                };
                if (options.through) {
                    finalOptions.through = __assign(__assign({}, options.through), { service: context.app.service(options.through.service) });
                }
                _a = context;
                return [4 /*yield*/, simpleJoin_1.default(context.result, finalOptions)];
            case 1:
                _a.result = _b.sent();
